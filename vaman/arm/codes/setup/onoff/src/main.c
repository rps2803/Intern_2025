...
#define GPIO_OPTION_A 17
#define GPIO_OPTION_B 18
#define GPIO_OPTION_C 22
#define GPIO_OPTION_D 27

extern int PyHal_GPIO_Set(uint8_t gpionum, uint8_t gpioval);
extern int PyHal_GPIO_Get(uint8_t gpionum);
...
    int correct_Y = (A && B) || (C && D);

    PyHal_GPIO_Set(GPIO_OPTION_A, 0);
    PyHal_GPIO_Set(GPIO_OPTION_B, 0);
    PyHal_GPIO_Set(GPIO_OPTION_C, 0);
    PyHal_GPIO_Set(GPIO_OPTION_D, 0);

    while (1)
    {
        if (Y == correct_Y)
        {
            PyHal_GPIO_Set(GPIO_OPTION_D, 1);
            delay_ms(500);
            PyHal_GPIO_Set(GPIO_OPTION_D, 0);
            delay_ms(500);
        }
